public class Reflecting : Activity
{
    ...
    public void RunReflectingActivity() {
        Type($"> {_questions[GetRandomQuestionPromptNumber()]}");
        MiniSpinner(8);
        Type($"> {_questions[GetRandomQuestionPromptNumber()]}");
        MiniSpinner(8);
    }
    ...
    public void DisplayPrompt() {
        Type("Consider the following prompt: ");
        Console.WriteLine();
        Type($"--- {_prompts[GetRandomPromptNumber()]} ---");
        Console.WriteLine();
        Type("When you have something in mind, press enter to continue");
        Console.ReadLine();
        Console.WriteLine();
        Type("Now ponder on each of the following questions as they related to this experience");
        PauseCountdownTimer();
    }
}